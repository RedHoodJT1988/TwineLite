...
Console.ReadKey();
Console.WriteLine("\n What seems like a clearing opens up in front of you as you desperately try to approach it. Revealing a path that splits into two, which path will you choose? path 'a' or 'b'?");
...
Console.ReadKey();
Console.WriteLine("\n 'Hello, traveler! Fret not, for you are now safe!' Says the friendly figure. 'Should I trust him?' You ask yourself. What do you do? Trust him 'a', or not 'b'?");
...
if (path == ConsoleKey.A)
{
    ...
    Console.ReadKey();
    Console.WriteLine("\n You look back, and he is gone, together with the forest., Only a vast open space is visible from your point of view. Are you safe now? You do not know the answer.");
}
else
{
    Console.WriteLine("\n You decide to not trust him, going back the way you came from. Although something is changed. It does not seem like you turly are going back. The path is not the same anymore. But a clearing appears, making you run towards it in hopes of finding an escape.");
    Console.ReadKey();
    Console.WriteLine("\n You find yourself at the edge of the forest, to your left you hear someone exclaim 'Hello World!' It seems to be the young person from earlier. How could he get here so fast? Are you safe now?");
    Console.ReadKey();
    Console.WriteLine("\n You look to the front, and you see what seems to be infiinte plains with no tree or building in sight. You look back, and the person is gone, together with the forest. Only a vast open spaceis what is visible from your point of view. Are you safe now? You do not know the answer.");
}
Console.ReadKey();
